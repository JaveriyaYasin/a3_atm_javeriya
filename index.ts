...
do {
    ...
    if (userInput.user_id == 'Javeriya' && userInput.user_pin == '1122') {
        ...
        console.log("Thank you for using Bank services!");
    } else
    {
        console.log("Invalid User ID or PIN.");
    }

} while (userInput.user_id != 'Javeriya' || userInput.user_pin != '1122');